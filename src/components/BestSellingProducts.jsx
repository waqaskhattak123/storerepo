...
const BestSellingProducts = ({ Category }) => {
  ...
  const fethingSingleData = async () => {
    ...
    try {
      ...
      console.log(
        "Error While Fetching the data in Best Selling Products",
        error
      );
    }
  };
  ...
  return (
    <div>
      ...
      {/* Today tag */}
      <div className="flex flex-col sm:flex-row mx-3 text-2xl font-bold ">
